...
class DB
{
	...
	public function DBConnect($Config) 
	{
		...
		(!function_exists('mysqli_connect') && Amysql::AmysqlNotice('当前PHP环境需要安装Mysqli扩展。'));
		$this -> DBS[$Config['ModelTag']] = @mysqli_connect($Config['Host'], $Config['User'], $Config['Password'], null, null, $Config['Socket']);
		(!$this -> DBS[$Config['ModelTag']] && Amysql::AmysqlNotice(mysqli_connect_error()));
